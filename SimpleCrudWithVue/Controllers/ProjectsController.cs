...
namespace SimpleCrudWithVue.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        {
            var result = Json(Envelope.Ok((await _context.Projects.ToListAsync())));
            return result;
        }
        ...
        public async Task<IActionResult> CreateProject([FromBody] Project project)
        {
            ...
            return Json(Envelope.Ok(project));
        }
